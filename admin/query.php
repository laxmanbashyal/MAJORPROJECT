...
if(isset($_GET['id'])) {
    ...
    header('Location: query.php?marked=1');
    exit();
}
...
if(isset($_GET['deleted'])) {
    $deleted_msg = 'Query from <strong>' . htmlspecialchars(urldecode($_GET['name'])) . '</strong> deleted successfully!';
}
...
<body>
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="mb-0"><i class="fas fa-envelope me-2"></i>User Queries</h4>
                <small class="text-muted">Total <?php echo $total_records; ?> queries received</small>
            </div>
            <div>
                <a href="pending_query.php" class="btn btn-warning me-2">
                    <i class="fas fa-clock me-2"></i>Pending Queries
                </a>
            </div>
        </div>
        ...
        <div class="table-container">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($row['query_status'] == 1): ?>
                                    <span class="badge-status read"><i class="fas fa-check-circle me-1"></i>Read</span>
                                <?php else: ?>
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">No queries received yet.</p>
                </div>
            <?php endif; ?>
